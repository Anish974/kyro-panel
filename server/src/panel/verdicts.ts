...
- INTRODUCTIONS & PROJECT ARCHITECTURE: When the candidate introduces their project, system architecture, solving multi-device issues, or problem domain (e.g. building software, DMS, drone controllers, solving mission planner limitations), actively evaluate and reward this technical depth and problem-solving initiative. Give fair credit (e.g. 3.0 - 4.0 depending on depth) for real software explanations rather than failing them at 0.0.
